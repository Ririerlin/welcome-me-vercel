...
export default function PhoneSimulator({
  ...
  return (
    <div className="relative mx-auto p-[3px] bg-gradient-to-tr from-pink-400 via-teal-300 via-purple-400 to-pink-500 rounded-[58px] shadow-[0_25px_60px_rgba(244,114,182,0.15)] dark:shadow-[0_25px_60px_rgba(139,92,246,0.15)] transition-all duration-500 hover:scale-[1.01] hover:shadow-[0_30px_75px_rgba(244,114,182,0.25)] w-full max-w-[360px] h-[760px] shrink-0">
      
      {/* Animated Stream light overlay inside borders */}
      <div className="absolute inset-0 bg-gradient-to-r from-pink-500/10 via-teal-300/5 to-purple-500/10 animate-pulse rounded-[58px] pointer-events-none"></div>

      {/* Main Glass Simulator Body */}
      <div className="relative w-full h-full rounded-[55px] bg-white/80 dark:bg-slate-950/80 backdrop-blur-2xl border border-white/40 dark:border-slate-800/40 flex flex-col overflow-hidden select-none font-sans transition-all duration-300">
